...
<img class="w-100 mb-10" src="{{ asset('media/helps/example.png') }}" alt="">
...
<div class="d-none cursor-pointer alert-push-success">
    <div class="d-flex align-items-center bg-light-success rounded p-5 mb-5 d-none">
                    <span class="svg-icon svg-icon-success mr-5">
                        {{ Metronic::getSVG('media/svg/icons/Navigation/Double-check.svg', 'svg-icon-lg') }}
                    </span>
        <div class="d-flex flex-column flex-grow-1 mr-2">
            <span class="font-weight-bold text-success font-size-lg mb-1">Ativado!</span>
            <span class="text-dark-50 font-size-sm">Notificação via banner foi ativada com sucesso.</span>
        </div>
    </div>
</div>
